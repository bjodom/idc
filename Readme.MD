...
```
Remember to exit the previous terminal session as one port forward and one VSCode session are your two connections to IDC.  In your local browser's address bar enter `http://localhost:800X`.
---  
